...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { assignment_id: @homework.assignment_id, final_date: @homework.final_date, message: @homework.message }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { assignment_id: @homework.assignment_id, final_date: @homework.final_date, message: @homework.message }
    assert_redirected_to homework_path(assigns(:homework))
  end
